    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt=""
          fill
          className="object-cover opacity-20 pixel-render"
          priority
        />
      </div>
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        {/* Pixel character - standing to the left on desktop */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
          ...
          >
            <div className="animate-float">
              <Image
                ...
                width={140}
                height={200}
                className="pixel-render drop-shadow-[0_0_15px_rgba(249,115,22,0.3)]"
              />
            </div>
          </motion.div>
          ...
          <div className="flex-1">
            ...
            <motion.div
              ...
              className="mb-5 inline-block md:hidden"
            >
              <div className="w-20 h-20 mx-auto rounded-lg overflow-hidden border-2 border-orange-500/50 glow-orange">
                <Image
                  src="/avatar.png"
